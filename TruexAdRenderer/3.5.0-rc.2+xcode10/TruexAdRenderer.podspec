Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://stash.truex.com/integration/TruexAdRenderer-tvOS-v3.5.0-rc.2%2Bxcode10.zip" }
  ...
  s.dependency 'InnovidAdRenderer', '1.3.11+xcode10'
