Pod::Spec.new do |s|
  ...
  s.source              = { :http => "https://stash.truex.com/integration/TruexAdRenderer-tvOS-v3.4.1%2Bxcode10.zip" }
  ...
  s.dependency 'InnovidAdRenderer', '1.3.9+xcode10'
